...
from user_data_analysis import calories, weekly_menu
# from weight_code.wifi_data import send_data
# aby aplikacja webowa działała również z konfigurowaną płytką,
# trzeba odkomentować wszystkie linie kodu z funkcją send_data (oraz jej import)
# gdy ta funkcja jest zakomentowana aplikacja webowa prawidłowo bez podłączonej
# płytki
...
####                   podajemy ścieżkę do bazy danych                     ####
