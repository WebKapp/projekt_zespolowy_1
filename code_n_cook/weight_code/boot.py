...
# _UART_RX_CHAR_UUID = bluetooth.UUID('0000ffb0-0000-1000-8000-00805f9b34fb')
# _UART_TX_CHAR_UUID = bluetooth.UUID('f000ffc0-0451-4000-b000-000000000000')
    ...
    def on_rx(data):
        ...
        for index,byte in enumerate(data):
            if index == 3:
                ...
                mass += int(bin(byte), 2)
        print(mass)
        # update_oled(product, str(mass))

    central.on_notify(on_rx)

########################################################
# Stuff relating to connecting device to the app.
